...
export class CustomerService {
    ...
    async searchCustomersByName(name) {
        try {
            ...
            return customers.filter(customer => customer.name.toLowerCase().includes(searchTerm));
        }
        catch (error) {
     ...
     */
    async getCustomersByBoilerModel(boilerModel) {
        try {
            const customers = await this.getAllCustomers();
            const searchTerm = boilerModel.toLowerCase();
            return customers.filter(customer => customer.boiler_model.toLowerCase().includes(searchTerm));
        }
        catch (error) {
     ...
     */
    async getCustomersWithOverdueMaintenance() {
        try {
            const customers = await this.getAllCustomers();
