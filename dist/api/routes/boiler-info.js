 ...
 */
router.get('/', authenticateApiKey, generalRateLimit, validateBoilerInfo, async (req, res) => {
    try {
 ...
 */
router.get('/:customer_id/warranty', authenticateApiKey, generalRateLimit, async (req, res) => {
    try {
 ...
 */
router.get('/:customer_id/efficiency', authenticateApiKey, generalRateLimit, async (req, res) => {
    try {
        const { customer_id } = req.params;
        // Get customer information
        const customer = await customerService.getCustomerById(customer_id);
...
function getOptimalEfficiency(boilerModel) {
...
function generateEfficiencyRecommendations(currentEfficiency, optimalEfficiency) {
    const recommendations = [];
